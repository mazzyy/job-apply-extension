...
class Question(Base):
    ...
    needs_review = Column(Integer, default=0)         # 1 = autogenerated, user should verify
    last_input_type = Column(String(40), nullable=True)  # number | text | textarea | select | radio
    last_max_length = Column(Integer, nullable=True)
    last_options = Column(Text, nullable=True)        # JSON list of select/radio options
